...
def mpn65_palette(as_cmap=False):
    """Returns a large qualitative color palette with 65 colors.
    https://github.com/google/palette.js/blob/master/palette.js#L802

    Parameters
    ----------
    as_cmap : bool, optional
        Whether to return a matplotlib colormap, by default False

    Returns
    -------
    matplotlib.colors.ListedColormap or list
        The colormap or list of colors
    """
