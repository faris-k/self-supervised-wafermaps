...
Welcome to `ssl_wafermap` contributor's guide.
...
If you experience bugs or general issues with `ssl_wafermap`, please have a look
...
You can help improve `ssl_wafermap` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`ssl_wafermap` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `ssl_wafermap`'s files. While this mechanism can
...
```
conda create -n ssl_wafermap python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/ssl_wafermap.git
   cd ssl_wafermap
   ```
...
5. Install [pre-commit]:
   ...
   `ssl_wafermap` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/ssl_wafermap
[issue tracker]: https://github.com/<USERNAME>/ssl_wafermap/issues
